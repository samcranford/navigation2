...
class BtActionNode : public BT::ActionNodeBase {
   public:
    ...
    BT::NodeStatus tick() override {
        ...
        if (rclcpp::ok() && !goal_result_available_) {
            ...
            if (goal_updated_ &&
                (goal_status == action_msgs::msg::GoalStatus::STATUS_EXECUTING || goal_status == action_msgs::msg::GoalStatus::STATUS_ACCEPTED)) {
                goal_updated_ = false;
                on_new_goal_received();
            }
    ...
    void halt() override {
        if (should_cancel_goal()) {
            ...
            if (rclcpp::spin_until_future_complete(node_, future_cancel, server_timeout_) != rclcpp::FutureReturnCode::SUCCESS) {
   ...
   protected:
    ...
    void on_new_goal_received() {
        ...
        if (rclcpp::spin_until_future_complete(node_, future_goal_handle, server_timeout_) != rclcpp::FutureReturnCode::SUCCESS) {
