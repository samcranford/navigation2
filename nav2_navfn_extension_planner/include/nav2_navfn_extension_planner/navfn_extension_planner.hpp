...
#ifndef NAV2_NAVFN_EXTESNION_PLANNER__NAVFN_EXTENSION_PLANNER_HPP_
#define NAV2_NAVFN_EXTESNION_PLANNER__NAVFN_EXTESNION_PLANNER_HPP_
...
class NavfnExtensionPlanner : public nav2_core::GlobalPlanner
{
public:
  /**
   * @brief constructor
   */
  NavfnExtensionPlanner();
...
protected:
  ...
  std::unique_ptr<NavFnExtension> planner_;
  ...
  // Costs lower or equal to this value will be ignored when goal cost has a cost greater than this value
  int low_cost_ignore_;
...
#endif  // NAV2_NAVFN_EXTENSION_PLANNER__NAVFN_EXTENSION_PLANNER_HPP_
