...
## Extension
The extension planner contains the same functionality as the Navfn Planner, except that any cell with a cost lower or equal to the the low cost ignore value will be set to the neutral value if the goal cell has a higher or equal cost to the low cost ignore value.